...
description: The event loop is the core of Node.js, allowing it to perform non-blocking I/O operations. It's a single-threaded loop that offloads operations to the system kernel when possible.
head:
  - - meta
    - name: og:title
      content: Understanding the Node.js Event Loop | Node.js - iDoc.dev
  - - meta
    - name: og:description
      content: The event loop is the core of Node.js, allowing it to perform non-blocking I/O operations. It's a single-threaded loop that offloads operations to the system kernel when possible.
  - - meta
    - name: twitter:title
      content: Understanding the Node.js Event Loop | Node.js - iDoc.dev
  - - meta
...
::: tip
Technically, the [poll](/nodejs/guide/nodejs-event-loop#poll) phase controls when timers are executed.
:::
