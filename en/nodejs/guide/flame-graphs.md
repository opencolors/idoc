---
title: Flame Graphs for Node.js Performance Optimization
description: Learn how to create flame graphs to visualize CPU time spent in functions and optimize Node.js performance.
head:
  - - meta
    - name: og:title
      content: Flame Graphs for Node.js Performance Optimization | Node.js - iDoc.dev
  - - meta
    - name: og:description
      content: Learn how to create flame graphs to visualize CPU time spent in functions and optimize Node.js performance.
  - - meta
    - name: twitter:title
      content: Flame Graphs for Node.js Performance Optimization | Node.js - iDoc.dev
  - - meta
